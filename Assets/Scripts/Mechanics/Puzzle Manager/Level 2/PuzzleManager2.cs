...
public class PuzzleManager2 : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        // }
        SaveManager.instance.currentLevel = 2;
    ...
    public void Checking()
    {
        if (rewardClaimed == true)
        {
            ...
            SaveManager.instance.SetRewardClaimed(2, true);
        ...
        if (SaveManager.instance.level_2_RewardClaimed == true)
        {
            rewardClaimed = true;
    ...
    public void RestartLevel()
    {
        ...
        if (rewardClaimed && levelFinished)
        {
            ...
            SaveManager.instance.level_2_completed = false;
            SaveManager.instance.Save();
        }
