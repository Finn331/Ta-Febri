...
{
    public static PuzzleManager4 Instance;
    ...
    private void Awake()
    {
        ...
        // }
        SaveManager.instance.currentLevel = 4;
    ...
    {
        AudioManager.instance.PlaySound(clickSFX);
        // SaveManager.instance.level_4_completed = true;
        // SaveManager.instance.Save();
    ...
    public void Checking()
    {
        if (rewardClaimed == true)
        {
            ...
            SaveManager.instance.SetRewardClaimed(4, true);
        ...
        if (SaveManager.instance.level_4_RewardClaimed == true)
        {
            rewardClaimed = true;
    ...
    public void RestartLevel()
    {
        ...
        if (rewardClaimed && levelFinished)
        {
            ...
            SaveManager.instance.level_4_completed = false;
            SaveManager.instance.Save();
        }
    ...
    {
        if (SaveManager.instance.level_4_completed == true)
        {
            levelFinished = true;
