...
public class PuzzleManager10 : MonoBehaviour
{
    public static PuzzleManager10 Instance;
    ...
    [SerializeField] private AudioClip level10Song;
    ...
    void Start()
    {
        AudioManager.instance.PlayMusic(level10Song, true);
        if (rewardClaimed)
        {
    ...
    public void Checking()
    {
        if (rewardClaimed == true)
        {
            ...
            SaveManager.instance.SetRewardClaimed(10, true);
        ...
        if (SaveManager.instance.level_10_RewardClaimed == true)
        {
            rewardClaimed = true;
        }
    }
    ...
    public void LevelFinishedCheck()
    {
        ...
        {
            SaveManager.instance.LevelCompleted(10, true);
        ...
        if (SaveManager.instance.level_10_completed == true)
        {
            levelFinished = true;
        }
    }
