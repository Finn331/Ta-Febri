...
public class PuzzleManager12 : MonoBehaviour
{
    public static PuzzleManager12 Instance;
    ...
    [SerializeField] private AudioClip level12Song;
    ...
    void Start()
    {
        AudioManager.instance.PlayMusic(level12Song, true);
        if (rewardClaimed)
        {
    ...
    public void Checking()
    {
        if (rewardClaimed == true)
        {
            ...
            SaveManager.instance.SetRewardClaimed(12, true);
        ...
        if (SaveManager.instance.level_12_RewardClaimed == true)
        {
            rewardClaimed = true;
        }
    }
    ...
    public void LevelFinishedCheck()
    {
        ...
        {
            SaveManager.instance.LevelCompleted(12, true);
        ...
        if (SaveManager.instance.level_12_completed == true)
        {
            levelFinished = true;
        }
    }
