...
{
    public static PuzzleManager7 Instance;
    ...
    private void Awake()
    {
        ...
        SaveManager.instance.currentLevel = 7;
    ...
    {
        AudioManager.instance.PlaySound(clickSFX);
        SaveManager.instance.level_7_completed = true;
        SaveManager.instance.Save();
    ...
    public void Checking()
    {
        if (rewardClaimed == true)
        {
            ...
            SaveManager.instance.SetRewardClaimed(7, true);
    ...
    public void RestartLevel()
    {
        ...
        if (rewardClaimed && levelFinished)
        {
            ...
            SaveManager.instance.level_7_completed = false;
            SaveManager.instance.Save();
        }
