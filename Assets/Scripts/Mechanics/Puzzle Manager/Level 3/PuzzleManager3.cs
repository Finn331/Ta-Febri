...
public class PuzzleManager3 : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        SaveManager.instance.currentLevel = 3;
    ...
    {
        AudioManager.instance.PlaySound(clickSFX);
        SaveManager.instance.level_3_completed = true;
        SaveManager.instance.Save();
    ...
    public void Checking()
    {
        if (rewardClaimed == true)
        {
            ...
            SaveManager.instance.SetRewardClaimed(3, true);
        ...
        if (SaveManager.instance.level_3_RewardClaimed == true)
        {
            rewardClaimed = true;
    ...
    public void RestartLevel()
    {
        ...
        if (rewardClaimed && levelFinished)
        {
            ...
            SaveManager.instance.level_3_completed = false;
            SaveManager.instance.Save();
        }
    ...
    {
        if (SaveManager.instance.level_3_completed == true)
        {
            levelFinished = true;
