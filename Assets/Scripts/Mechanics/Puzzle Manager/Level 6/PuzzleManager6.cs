...
{
    public static PuzzleManager6 Instance;
    ...
    [SerializeField] private AudioClip level6Song;
    ...
    void Start()
    {
        AudioManager.instance.PlayMusic(level6Song, true);
        if (rewardClaimed)
        {
    ...
    public void Checking()
    {
        if (rewardClaimed == true)
        {
            ...
            SaveManager.instance.SetRewardClaimed(6, true);
        ...
        if (SaveManager.instance.level_6_RewardClaimed == true)
        {
            rewardClaimed = true;
        }
    }
    ...
    public void LevelFinishedCheck()
    {
        ...
        {
            SaveManager.instance.LevelCompleted(6, true);
        ...
        if (SaveManager.instance.level_6_completed == true)
        {
            levelFinished = true;
        }
    }
