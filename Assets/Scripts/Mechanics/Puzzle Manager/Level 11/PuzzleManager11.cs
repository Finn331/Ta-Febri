...
public class PuzzleManager11 : MonoBehaviour
{
    public static PuzzleManager11 Instance;
    ...
    [SerializeField] private AudioClip level11Song;
    ...
    void Start()
    {
        AudioManager.instance.PlayMusic(level11Song, true);
        if (rewardClaimed)
        {
    ...
    public void Checking()
    {
        if (rewardClaimed == true)
        {
            ...
            SaveManager.instance.SetRewardClaimed(11, true);
        ...
        if (SaveManager.instance.level_11_RewardClaimed == true)
        {
            rewardClaimed = true;
        }
    }
    ...
    public void LevelFinishedCheck()
    {
        ...
        {
            SaveManager.instance.LevelCompleted(11, true);
        ...
        if (SaveManager.instance.level_11_completed == true)
        {
            levelFinished = true;
        }
    }
