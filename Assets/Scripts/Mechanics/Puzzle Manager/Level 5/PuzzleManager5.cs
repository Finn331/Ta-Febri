...
{
    public static PuzzleManager5 Instance;
    ...
    [SerializeField] private AudioClip level5Song;
    ...
    void Start()
    {
        AudioManager.instance.PlayMusic(level5Song, true);
        if (rewardClaimed)
        {
    ...
    public void Checking()
    {
        if (rewardClaimed == true)
        {
            ...
            SaveManager.instance.SetRewardClaimed(5, true);
        ...
        if (SaveManager.instance.level_5_RewardClaimed == true)
        {
            rewardClaimed = true;
        }
    }
    ...
    public void LevelFinishedCheck()
    {
        ...
        {
            SaveManager.instance.LevelCompleted(5, true);
        ...
        if (SaveManager.instance.level_5_completed == true)
        {
            levelFinished = true;
        }
    }
